...
t="0.1"
clip_grad="10"
folder="pass_${dataset}-${n_tasks}T_k${k}_p${p}_t${t}_cg${clip_grad}_lr${lr}_ep${n_epochs}"
...
$cmd  --kd_weight $k --protoAug_weight $p --temp $t --use_clip_grad --clip_grad $clip_grad &> nohups/nohup_${folder}.out &
