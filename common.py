...
def parse_args():
    ...
    parser.add_argument('--baseline', type=str, choices=['no_rejection', 'with_rejection'])
    parser.add_argument('--eval_model', type=int, default=4, choices=[0,1,2,3,4], help="model task id to be evaluated")
    parser.add_argument('--xir', type=str, default=None, help='if provided, load model and test')
    ...
    parser.add_argument('--framework', type=str, choices=['more', 'build'])
    parser.add_argument('--method', type=str, choices=['more_fw', 'more_bw', 'build'])
    ...
    parser.add_argument('--farood', action='store_true')            # EDIT: added parameter
    parser.add_argument('--farood_data', type=str, default='mnist', help="choose a dataset very different from the id dataset")        # EDIT: added argument
    parser.add_argument('--in_train_eval', action='store_true')
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--init_task', type=int, default=0)
    parser.add_argument('--n_tasks', type=int, default=5)
    parser.add_argument('--validation', type=float, default=None, help='Proportion of dataset used e.g. if set 0.9, 90\% of training data is used for training and rest 10\% is used for validation')
    ...
    parser.add_argument('--load_dir', type=str)         # EDIT: added --load_dir argument
    # Network
    ...
    parser.add_argument('--ood_det', type=str, default='msp', choices=['msp', 'react', 'ash', 'scale', 'dice'])
